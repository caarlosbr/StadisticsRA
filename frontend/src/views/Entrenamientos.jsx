...
export default function Entrenamientos() {
    ...
    // Obtener los ejercicios al cargar
    useEffect(() => {
    ...
    const buscarPorFecha = async () => {
        ...
        const res = await fetch(`http://localhost:3001/api/entrenamientos/${usuario.id}/${fechaBuscar}`);
                    ...
                    {series.map((serie, index) => (
                        <HStack key={index} spacing={4}>
                            <Select
                                ...
                                onChange={(e) =>
                                    handleChangeSerie(index, "ejercicio_id", e.target.value)
                                }
                            >
                            ...
                            <Input
                                ...
                                value={serie.peso}
                                onChange={(e) =>
                                    handleChangeSerie(index, "peso", e.target.value)
                                }
                            />
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    handleChangeSerie(index, "repeticiones", e.target.value)
                                }
                            />
                        </HStack>
                    ))}
